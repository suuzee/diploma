                  ...
                  <table class="table table-striped">
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td><?php echo $question -> inform_date;?></td>
                              <td><a href="//q.qunarzz.com/diploma/admin/delQuestion?questionId=<?php echo $question -> question_id?>">删除</a></td>
                          </tr>
                          <?php }?>
                          <?php
			            	  if($total > $pagesize){
